...
public class MergeSortedGrouperTest
{
  @Test
  public void testAggregate()
  {
    final TestColumnSelectorFactory columnSelectorFactory = GrouperTestUtil.newColumnSelectorFactory();
    final MergeSortedGrouper<Integer> grouper = newGrouper(columnSelectorFactory, 1024);
  ...
  private MergeSortedGrouper<Integer> newGrouper(
  ...
  )
  {
    ...
    final MergeSortedGrouper<Integer> grouper = new MergeSortedGrouper<>(
