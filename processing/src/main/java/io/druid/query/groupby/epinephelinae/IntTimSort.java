...
/**
 * Borrowed from {@link java.util.TimSort}
 */
public class IntTimSort
{
   ...
   */
  static void sort(
      int[] a, int lo, int hi, IntComparator c,
  ...
  private static int gallopLeft(
      int key, int[] a, int base, int len, int hint,
      IntComparator c
  )
  {
  ...
  private static int gallopRight(
      int key, int[] a, int base, int len,
