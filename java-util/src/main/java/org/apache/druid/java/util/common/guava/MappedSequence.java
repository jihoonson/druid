...
public class MappedSequence<T, Out> implements Sequence<Out>
{
  ...
  @Override
  public <OutType> Yielder<OutType> toYielder(Supplier<OutType> initValue, YieldingAccumulator<OutType, Out> statefulAccumulator, Supplier<YieldingAccumulator<OutType, Out>> accumulator)
  {
