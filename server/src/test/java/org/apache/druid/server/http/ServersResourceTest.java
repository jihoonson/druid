...
public class ServersResourceTest
{
  ...
  public void testGetClusterServersFull() throws Exception
  {
    ...
    String expected = "[{\"host\":\"host\","
                      ...
                      + "\"shardSpec\":{\"type\":\"numbered\",\"partitionNum\":0,\"partitions\":1},\"binaryVersion\":null,\"size\":1,\"overshadowedSegments\":[],\"atomicUpdateGroup\":[0],\"identifier\":\"dataSource_2016-03-22T14:00:00.000Z_2016-03-22T15:00:00.000Z_v0\"}},"
                      + "\"currSize\":1}]";
