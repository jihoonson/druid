...
public class RealtimePlumber implements Plumber
{
  ...
  public <T> QueryRunner<T> getQueryRunner(final Query<T> query)
  {
    ...
    final Iterable<DataSourceWithSegmentSpec> iterables = query.getDataSources();
    DataSourceWithSegmentSpec source = Iterables.getOnlyElement(iterables);
    return texasRanger.getQueryRunnerForIntervals(
        query,
        ImmutableMap.of(
            Iterables.getOnlyElement(source.getDataSource().getNames()),
