...
public class DruidSegmentEntity implements InputEntity
{
  private final SegmentLoader segmentLoader;
  private final DataSegment segment;
  private final Interval intervalFilter;

  public DruidSegmentEntity(SegmentLoader segmentLoader, DataSegment segment, Interval intervalFilter)
  {
