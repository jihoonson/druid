...
public class CompactionTask extends AbstractTask
{
  ...
  private static final String TYPE = "compaction";
  ...
  {
    super(makeId(id, TYPE, dataSource), null, taskResource, dataSource, context);
  ...
  public TaskStatus run(final TaskToolbox toolbox) throws Exception
  {
    ...
    log.info(jsonMapper.writerWithDefaultPrettyPrinter().writeValueAsString(indexTaskSpec));
      ...
      throws IOException, SegmentLoadingException
  {
    ...
    // TODO: same merge strategy with metadata?
    ...
    log.info("interval: " + interval + ", gran: " + expectedGranularity);
